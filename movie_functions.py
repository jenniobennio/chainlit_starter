...
def buy_ticket(theater, movie, showtime):
    print(f"Buying a ticket for '{movie}' at '{theater}' for the showtime at {showtime}.")

def confirm_ticket_purchase(theater, movie, showtime):
    print(f"Confirming buying a ticket for '{movie}' at '{theater}' for the showtime at {showtime}.")
...
def get_showtimes(title, location):
    print("inside get_showtimes() function " + title + " " + location + "--")
    params = {
...
def get_reviews(movie_id):
    print("inside get_reviews() function " + movie_id + "--")
